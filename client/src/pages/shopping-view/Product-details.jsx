        ...
        <DialogContent className='grid grid-cols-2 gap-8 sm:p-12 max-w-[90vw] md:max-w-[80vw] lg:max-w-[70vw]'>
            ...
            <div className="">
                ...
                <div className="flex items-center justify-between">
                    <p className={`text-3xl font-bold text-primary ${productDetails?.price > 0 ? 'line-through' : ''}`}>₹ {productDetails?.price}</p>
                    {
                ...
                <div className="max-h-[300px] overflow-auto">
                         ...
                         <div className='flex gap-4'>
                            ...
                            <div className="grid gap-1">
                                <div className="flex items-center gap-2">
                                    <h3 className='font-bold'>aswin</h3>
                                </div>
                                <div className='flex items-center gap-0.5'>
                                    <StarIcon className='w-5 h-5 fill-primary'/>
                                    <StarIcon className='w-5 h-5 fill-primary'/>
                    ...
                    <div className='mt-6 flex'>
                        <Input className='m-1' placeholder='Write a review..'/>
